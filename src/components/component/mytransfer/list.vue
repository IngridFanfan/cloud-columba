        ...
        <div :class="bodyClasses">
            ...
            <ul :class="prefixCls + '-content'">
                <li
                    ...
                    <i v-show="item.expand==true" class="ivu-icon ivu-icon-ios-arrow-down itemExpand" @click.stop="item.expand=!item.expand"></i>
                    <i v-show="item.expand==false" class="ivu-icon ivu-icon-ios-arrow-forward itemExpand" @click.stop="item.expand=!item.expand"></i>
                    <Checkbox :value="isCheck(item)" :disabled="item.disabled" @click.stop="item.expand=true"></Checkbox>
                    <span v-show="item.groupePointer.expand" @click.stop="item.expand=!item.expand" v-html="showLabel(item)"></span>
                </li>
